        ...
        <section className="pt-32 pb-24 px-6 bg-s0">
          <div className="max-w-6xl mx-auto">
            <FadeUp>
              ...
              <p className="font-body font-light text-[18px] md:text-[20px] text-2 leading-[1.85] mt-6 max-w-2xl">
              ...
              <FadeUp>
                <div className="bg-card border rounded-[16px] p-[28px] h-full">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="font-display font-bold text-[22px] text-1">Account</h2>
                  </div>

                  <div className="space-y-3">
                    <div className="flex items-start justify-between gap-4">
                      <p className="font-body text-[14px] text-3 uppercase tracking-widest">Email</p>
                      <p className="font-body text-[16px] text-2 text-right break-all">{user.email}</p>
                    </div>

                    <div className="flex items-start justify-between gap-4">
                      <p className="font-body text-[14px] text-3 uppercase tracking-widest">Status</p>
                    ...
                    {lastSignIn && (
                      <div className="flex items-start justify-between gap-4">
                        <p className="font-body text-[14px] text-3 uppercase tracking-widest">Last sign in</p>
                        <p className="font-body text-[16px] text-2 text-right">{new Date(lastSignIn).toLocaleString()}</p>
                      </div>
                    )}
                  </div>
              ...
              <FadeUp delay={0.06}>
                <div className="bg-card border rounded-[16px] p-[28px] h-full">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="font-display font-bold text-[22px] text-1">Quick actions</h2>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <Link href="/how-it-works" className="btn-secondary w-full">
                      How it works
                    </Link>
                  ...
                  <p className="font-body font-light text-[14px] text-3 leading-[1.7] mt-6">
              ...
              <FadeUp delay={0.12}>
                <div className="bg-card border rounded-[16px] p-[28px] h-full">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="font-display font-bold text-[22px] text-1">Plan</h2>
                  </div>
              ...
              <div className="bg-card border rounded-[16px] p-[28px]">
                <div className="flex items-center justify-between gap-4 flex-wrap">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 className="font-display font-bold text-[22px] text-1">Saved scans</h2>
                  </div>
                  <div className="flex items-center gap-3">
                ...
                <p className="font-body font-light text-[18px] text-2 leading-[1.85] mt-4 max-w-3xl">
              ...
              <FadeUp delay={0.22}>
                <div className="bg-card border rounded-[16px] p-[28px] h-full">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="font-display font-bold text-[22px] text-1">Help</h2>
                  </div>
                  <p className="font-body font-light text-[18px] text-2 leading-[1.85]">
              ...
              <FadeUp delay={0.26}>
                <div className="bg-card border rounded-[16px] p-[28px] h-full">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="font-display font-bold text-[22px] text-1">Legal</h2>
                  </div>
                  <p className="font-body font-light text-[18px] text-2 leading-[1.85]">
