...
export function AuthShell({
  ...
  return (
    <div className="bg-s0 text-1 min-h-screen">
      <Navbar />
      <main className="pt-[68px] px-5 sm:px-6 py-12 md:py-24">
        <div className="max-w-[460px] mx-auto">
          <div className="bg-card border rounded-[16px] p-6 sm:p-[28px]">
            ...
            <h1 className="font-display font-extrabold text-[28px] md:text-[32px] text-1 leading-tight">
              {title}
            </h1>
            <p className="font-body font-light text-[15px] md:text-[16px] text-2 leading-[1.7] md:leading-[1.8] mt-3">
              {subtitle}
            </p>
