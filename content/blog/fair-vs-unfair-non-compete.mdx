...
If you are asked to sign a non-compete, read it carefully. A fair non-compete should have a narrow geographic scope, a short time period, and a specific definition of what counts as a competitor. If it does not, negotiate — or walk away from the deal if the terms are too restrictive.
